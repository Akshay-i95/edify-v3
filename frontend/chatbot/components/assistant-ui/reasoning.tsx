...
// Simple scroll lock hook replacement
const useScrollLock = (ref: React.RefObject<HTMLElement | null>, duration: number) => {
  return useCallback(() => {
 ...
 * ```
 */
const ReasoningImpl: FC = () => <MarkdownText />;
...
const ReasoningGroupImpl: FC<{
  ...
  /**
   * For now, we don't detect streaming state dynamically.
   * You can enhance this by passing props or using context.
   */
